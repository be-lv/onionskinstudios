...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-eVHz5G7F.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-DJHLZhBi.js").then((n) => n.r),
...
var ROUTER_BASEPATH = "onionskinstudios";
var SERVER_FN_BASE = "/onionskinstudios/_serverFn/";
